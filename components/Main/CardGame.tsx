...
const CardGame: React.FC<CardGameProps> = ({ game }) => {
	return (
		<div className='xl:max-w-[514px] 3xl:h-[393px] flex flex-col gap-2 hover:shadow-xl md:hover:shadow-[0_4px_32px_0_#d3e2ff4c] rounded-xl duration-500 md:hover:-translate-y-3 cursor-pointer carousel-item max-w-[242px] relative md:max-w-[336px] lg:max-w-[424px] border border-slate-600'>
