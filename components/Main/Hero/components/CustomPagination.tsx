...
const CustomPagination: FC<CustomPaginationProps> = ({ totalSlides, activeIndex, onBulletClick }) => {
  return (
    <div className='absolute top-[94%] left-[50%] translate-x-[-50%] translate-y-[-42%] md:top-[88%] md:translate-y-[-42%] lg:left-[13%] lg:top-[50%]  lg:translate-y-[-50%] z-10 '>
      <div
        className="flex justify-center gap-6 lg:gap-8 xl:gap-10 lg:flex-col">
